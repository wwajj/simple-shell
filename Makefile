...
shell: y.tab.o lex.yy.o Shell.o PipeCommand.o SimpleCommand.o ListCommands.o Command.o IfCommand.o WhileCommand.o ForCommand.o Shell.o 
	$(CC) $(CCFLAGS) $(WARNFLAGS) -o shell lex.yy.o y.tab.o Shell.o PipeCommand.o SimpleCommand.o ListCommands.o Command.o IfCommand.o WhileCommand.o ForCommand.o 

#shell: y.tab.o lex.yy.o Shell.o PipeCommand.o SimpleCommand.o ListCommands.o Command.o IfCommand.o WhileCommand.o ForCommand.o Shell.o $(EDIT_MODE_OBJECTS)
#	$(CC) $(CCFLAGS) $(WARNFLAGS) -o shell lex.yy.o y.tab.o Shell.o PipeCommand.o SimpleCommand.o ListCommands.o Command.o IfCommand.o WhileCommand.o ForCommand.o $(EDIT_MODE_OBJECTS)
